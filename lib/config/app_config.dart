...
class AppConfig {
  // API Base URLs
  static String get apiBaseUrl => dotenv.env['API_BASE_URL'] ?? 'https://uat.viaridez.com/api';
  static String get apiBaseUrlNoApi => dotenv.env['API_BASE_URL_NO_API'] ?? 'https://uat.viaridez.com';

  // OpenStreetMap URLs
  static String get osmNominatimBaseUrl => dotenv.env['OSM_NOMINATIM_BASE_URL'] ?? 'https://nominatim.openstreetmap.org';
  static String get osmTileUrl => dotenv.env['OSM_TILE_URL'] ?? 'https://tile.openstreetmap.org/{z}/{x}/{y}.png';
  static String get osmTileUrlWithSubdomain => dotenv.env['OSM_TILE_URL_WITH_SUBDOMAIN'] ?? 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
